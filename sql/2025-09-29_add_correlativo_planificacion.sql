...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE "TOMA_FISICA"."PLANIFICACION"
      ADD COLUMN "FECHA_ACTUALIZACION" TIMESTAMP WITHOUT TIME ZONE;
  END IF;
END $$;
...
-- Inicializar la fecha de actualización para registros existentes
UPDATE "TOMA_FISICA"."PLANIFICACION"
SET "FECHA_ACTUALIZACION" = COALESCE("FECHA_ACTUALIZACION", NOW());
